 ...
 * 监听item layout单击事件
 */
inline fun <T : Any, VH, Adapter : AbsListViewAdapter<T, VH>> Adapter.clickListener(crossinline block: (holder: VH) -> Unit): Adapter {
 ...
 * 监听item layout长按事件
 */
inline fun <T : Any, VH, Adapter : AbsListViewAdapter<T, VH>> Adapter.longClickListener(crossinline block: (holder: VH) -> Unit): Adapter {
